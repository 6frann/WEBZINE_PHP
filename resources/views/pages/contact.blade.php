...
<body class="bg-gray-100 text-gray-800 font-body leading-relaxed">
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center">
                    <a href="index.html" class="text-2xl font-bold tracking-tighter uppercase">
                        <img src="./3A616A23-26BA-4E6B-B32D-D79D6B66D7EC 2.PNG" alt="logo" class="h-20 w-auto">
                    </a>
                    ...
                    <!-- Barre de recherche -->
                    <!-- <div class="desktop-search search-container collapsed relative h-10 rounded overflow-hidden">
                        <input type="text" 
    ...
    <div class="mobile-menu fixed top-0 right-0 w-64 h-full bg-primary text-white z-50 p-6 overflow-y-auto">
        ...
        <!-- <div class="search-container expanded relative h-10 rounded overflow-hidden">
            <input type="text" 
                   placeholder="Rechercher..." 
                   class="search-input absolute w-full h-full py-2 px-4 bg-white/10 text-white placeholder-white/60 focus:outline-none">
            <button class="absolute right-3 top-1/2 -translate-y-1/2 text-white w-6 h-6 flex items-center justify-center hover:text-accent transition-colors" onclick="toggleSearch()">
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">123 Rue du Rap<br>75000 Paris, France</p>
                                    </div>
                                </div>
                                <div class="flex items-start">
                                    <svg class="w-6 h-6 text-accent mt-1 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">contact@rapactu.com</p>
                                    </div>
                                </div>
                                <div class="flex items-start">
                                    <svg class="w-6 h-6 text-accent mt-1 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-8">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-accent hover:text-white transition-colors">
    ...
    <footer class="bg-primary text-white py-8 mt-16">
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center text-center">
                <img src="./3A616A23-26BA-4E6B-B32D-D79D6B66D7EC 2.PNG" alt="logo" class="h-32 w-auto mb-4">
