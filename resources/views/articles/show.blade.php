...
@section('content')
    ...
    <!-- Related Articles -->
    {{-- <a href="{{route('category',['slug'=>$article->category->slug])}}" class="view-all-btn ml-6">
    ...
    <section class="mt-16">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{route('categories.show',['slug'=>$article->category->slug])}}" class="view-all-btn ml-6">
                <span class="text">Voir tout</span>
                <span class="arrow-container">
                    <span class="arrow-line"></span>
                    <span class="arrow-head"></span>
