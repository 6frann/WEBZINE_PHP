<nav class="mb-8">
    <ul class="space-y-4">
        ...
        <li>
            <a href="{{route('pages.videos.index')}}" class="nav-link block py-2 uppercase text-sm tracking-wide hover:text-accent">Vidéos</a>
        </li>
        <li>
            <a href="{{route('pages.contact')}}" class="nav-link block py-2 uppercase text-sm tracking-wide hover:text-accent">Contact</a>
        </li>
    </ul>
</nav>