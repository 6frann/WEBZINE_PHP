    ...
    <div class="py-2 bg-black">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center">
                <a href="{{route('home')}}" class="text-3xl font-display tracking-wider uppercase">
                ...
                <nav class="desktop-nav mt-4 flex-1">
                    <ul class="flex min-w-max py-1 justify-center">
                        <li class="px-4 first:pl-0">
                            <a href="{{route('home')}}" class="nav-link text-base py-2 hover:text-accent relative group">
                                Accueil
                                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
                            </a>
                        </li>
                        <li class="px-4">
                            <a href="{{route('articles.index')}}" class="nav-link text-base py-2 hover:text-accent relative group">
                                Actualités
                                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
                            </a>
                        </li>
                        <li class="px-4">
                            <a href="{{route('videos.index')}}" class="nav-link text-base py-2 hover:text-accent relative group">
                                Vidéos
                                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
                            </a>
                        </li>
                        <li class="px-4">
                            <a href="{{route('contact')}}" class="nav-link text-base py-2 hover:text-accent relative group">
                                Contact
                                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full"></span>
                            </a>
                        </li>
